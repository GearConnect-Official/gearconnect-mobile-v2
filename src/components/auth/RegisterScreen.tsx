...
export default function RegisterScreen() {
    ...
    const { username, setUsername, email, setEmail, password, setPassword, code, setCode, pendingVerification, errorMessage, apiError, isBusy, onSignUpPress, onVerifyPress } = useRegisterForm();
